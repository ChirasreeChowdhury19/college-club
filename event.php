							...
							<div class="intro_container d-flex flex-column align-items-start justify-content-end">
								<div class="intro_content">
									...
									<div class="intro_meta">
										...
										<div class="intro_instructors"><a href=>Prof. Nilanjan Byabarta</a> and <span><a href=>5 other instructors</a></span></div>
									</div>
								</div>
							</div>
						</div>
								...
								<div class="row judges_row">
									<div class="col-lg-4 col-md-6">
										<div class="judge d-flex flex-row align-items-center justify-content-start">
											<div class="judge_image"><div><img src="images/instructor_6.jpg" alt=""></div></div>
											<div class="instructor_content">
												<div class="instructor_name"><a href="instructors.html">Prof. Sukalyan Goswami</a></div>
									...
									<div class="col-lg-4 col-md-6">
										<div class="judge d-flex flex-row align-items-center justify-content-start">
											<div class="judge_image"><div><img src="images/instructor_1.jpg" alt=""></div></div>
											<div class="instructor_content">
