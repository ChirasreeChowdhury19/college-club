					...
					<div class="row instructors_row">
						...
						<div class="col-lg-4 instructor_col">
							<div class="instructor text-center">
								...
								<div class="instructor_name"><a href="instructors.html">Lahama Banerjee</a></div>
						...
						<div class="col-lg-4 instructor_col">
							<div class="instructor text-center">
								...
								<div class="instructor_name"><a href="instructors.html">Avirup Roy</a></div>
					...
					<div class="row teachers_row">
						<div class="col-lg-4 col-md-6">
							<div class="teacher d-flex flex-row align-items-center justify-content-start">
								<div class="teacher_image"><div><img src="images/instructor_2.jpg" alt=""></div></div>
								<div class="teacher_content">
									<div class="teacher_name"><a href="instructors.html">Suvra Shaw</a></div>
						...
						<div class="col-lg-4 col-md-6">
							<div class="teacher d-flex flex-row align-items-center justify-content-start">
								<div class="teacher_image"><div><img src="images/instructor_3.jpg" alt=""></div></div>
								<div class="teacher_content">
									<div class="teacher_name"><a href="instructors.html">Chirashree Chowdhury</a></div>
									<div class="teacher_title">Student</div>
								</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-6">
							<div class="teacher d-flex flex-row align-items-center justify-content-start">
								...
								<div class="teacher_content">
									<div class="teacher_name"><a href="instructors.html">Kaustav Roy</a></div>
									<div class="teacher_title">Student</div>
								</div>
							</div>
						</div>
